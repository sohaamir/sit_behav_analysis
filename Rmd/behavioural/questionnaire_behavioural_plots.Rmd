...
required_packages <- c("ggplot2", "tidyverse", "ggpubr", "rstatix", "ez", "lme4", 
                       ...
                       "effects", "here", "lm.beta", "effectsize", "parallel", 
                       "gridExtra", "grid", "conflicted")
...
# Process only main questionnaires
...
# Plot and save main scale relationships only
...
analysis_params <- list(
  ...
  subscale_mapping = SUBSCALE_MAPPING  # Kept for reference only
)

# Format and save text results (without subscale results)
results_text <- format_results_overall(results, NULL, analysis_params)
...
# Run post-hoc tests for significant relationships
message("\n\n====== RUNNING POST-HOC TESTS ======\n")

# Run post-hoc tests for LSAS on choice switching
message("Running post-hoc tests for LSAS on choice switching...")
lsas_choice_posthoc <- run_posthoc_tests(
  model = switch_results[["lsas"]]$moderation_results$main_results$model,
  data = switch_results[["lsas"]]$processed_data,
  var_name = "lsas",
  analysis_type = "choice_consensus",
  output_dir = analysis_dir
)
lsas_choice_plots <- plot_posthoc_simple_slopes(
  data = switch_results[["lsas"]]$processed_data,
  var_name = "lsas",
  analysis_type = "choice_consensus",
  output_dir = analysis_dir,
  test_results = lsas_choice_posthoc$test_results
)

# Run post-hoc tests for AQ-10 on choice switching
message("Running post-hoc tests for AQ-10 on choice switching...")
aq10_choice_posthoc <- run_posthoc_tests(
  model = switch_results[["aq_10"]]$moderation_results$main_results$model,
  data = switch_results[["aq_10"]]$processed_data,
  var_name = "aq_10",
  analysis_type = "choice_consensus",
  output_dir = analysis_dir
)
aq10_choice_plots <- plot_posthoc_simple_slopes(
  data = switch_results[["aq_10"]]$processed_data,
  var_name = "aq_10",
  analysis_type = "choice_consensus",
  output_dir = analysis_dir,
  test_results = aq10_choice_posthoc$test_results
)

# Run post-hoc tests for DASS on choice switching
message("Running post-hoc tests for DASS on choice switching...")
dass_choice_posthoc <- run_posthoc_tests(
  model = switch_results[["dass"]]$moderation_results$main_results$model,
  data = switch_results[["dass"]]$processed_data,
  var_name = "dass",
  analysis_type = "choice_consensus",
  output_dir = analysis_dir
)
dass_choice_plots <- plot_posthoc_simple_slopes(
  data = switch_results[["dass"]]$processed_data,
  var_name = "dass",
  analysis_type = "choice_consensus",
  output_dir = analysis_dir,
  test_results = dass_choice_posthoc$test_results
)
...
# Run post-hoc tests for SSMS on bet difference
message("Running post-hoc tests for SSMS on bet difference...")
ssms_bet_posthoc <- run_posthoc_tests(
  model = within_trial_results[["ssms"]]$moderation_results$main_results$model,
  data = within_trial_results[["ssms"]]$processed_data,
  var_name = "ssms",
  analysis_type = "within_trial_switch",
  output_dir = analysis_dir
)
ssms_bet_plots <- plot_posthoc_simple_slopes(
  data = within_trial_results[["ssms"]]$processed_data,
  var_name = "ssms",
  analysis_type = "within_trial_switch",
  output_dir = analysis_dir,
  test_results = ssms_bet_posthoc$test_results
)

# Run post-hoc tests for LSAS on bet difference
message("Running post-hoc tests for LSAS on bet difference...")
lsas_bet_posthoc <- run_posthoc_tests(
  model = within_trial_results[["lsas"]]$moderation_results$main_results$model,
  data = within_trial_results[["lsas"]]$processed_data,
  var_name = "lsas",
  analysis_type = "within_trial_switch",
  output_dir = analysis_dir
)
lsas_bet_plots <- plot_posthoc_simple_slopes(
  data = within_trial_results[["lsas"]]$processed_data,
  var_name = "lsas",
  analysis_type = "within_trial_switch",
  output_dir = analysis_dir,
  test_results = lsas_bet_posthoc$test_results
)

# Run post-hoc tests for AQ-10 on bet difference
message("Running post-hoc tests for AQ-10 on bet difference...")
aq10_bet_posthoc <- run_posthoc_tests(
  model = within_trial_results[["aq_10"]]$moderation_results$main_results$model,
  data = within_trial_results[["aq_10"]]$processed_data,
  var_name = "aq_10",
  analysis_type = "within_trial_switch",
  output_dir = analysis_dir
)
aq10_bet_plots <- plot_posthoc_simple_slopes(
  data = within_trial_results[["aq_10"]]$processed_data,
  var_name = "aq_10",
  analysis_type = "within_trial_switch",
  output_dir = analysis_dir,
  test_results = aq10_bet_posthoc$test_results
)
...
# Run analysis for each questionnaire (main scales only)
